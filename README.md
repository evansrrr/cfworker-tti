...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/tti
```

A live public deployment of this template is available at [https://tti.templates.workers.dev](https://tti.templates.workers.dev)
